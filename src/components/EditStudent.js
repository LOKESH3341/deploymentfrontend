...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://deploymentbackend-8z6w.onrender.com/studentRoute/update-student/"+id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://deploymentbackend-8z6w.onrender.com/studentRoute/update-student/"+id, data)
        .then((res)=>{
            if(res.status === 200)
